...
Created on Wed Oct  8 19:56:06 2025
    ...
    ptype : {"default", "asymp", "perm"}, optional
        ...
        Note:
            ...
            This distribution depends on the marginal distributions and tie
            structure of the observed data.
    
            In contrast, the asymptotic p-values approximate the *unconditional*
            null distribution of Λ, calibrated from extremely large independent
            Monte Carlo simulations. As a result, the asymptotic p-values may be
            more accurate and more stable than permutation p-values, especially
            for moderate n, skewed data, or substantial ties.
